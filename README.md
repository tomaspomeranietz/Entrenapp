...
2. Andá a **SQL Editor** y corré, en este orden, uno por vez, el contenido de cada archivo de la carpeta `sql/`:
   ...
   9. `009_content_studies_service_dm.sql`
   10. `010_required_city_visibility_follows.sql`
   11. `011_fix_security_definer_view.sql`
   12. `012_fix_routine_media_gating.sql`
